...
void myDrawText(int x,int y,int ht, string str,COLORREF lineColor,COLORREF fillColor)
{
	WCHAR wstr[20]={};
...
void myDrawTextWithFont(int x,int y,int ht,string str,COLORREF lineColor,COLORREF fillColor)
{
	WCHAR wstr[30]={};
